    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-lg-10 col-md-10">
                <h1 class="display-2 text-white">Atualizar corredor</h1>
                <p class="text-white mt-0 mb-5">A atualização do corredor é para editar as informações do corredor e organizar os livros em prateleiras.</p>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Corredor: <?= $corredor->corredor?></h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('corredores/atualizar') ?>" method="POST" id="cadastrar-corredor">
                        <input type="hidden" name="input-id" value="<?= $corredor->id_corredor?>">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="input-corredor" name="input-corredor" class="form-control form-control-alternative" required value="<?= $corredor->corredor?>">
                                </div>
                            </div>
                        </div>
...
<script>
    $(() => {
        ...
        $('#table-prateleiras tbody tr td').map((i, it) => {
            prateleiras.push($(it).find('span').text())
        })
